...
map.set("room-api-login-room", (core, socket, arg) => core.socketApi.roomApiLoginRoom(socket, arg));
map.set("room-api-login-user", (core, socket, arg) => core.socketApi.roomApiLoginUser(socket, arg));
